            ...
            switch (login_provider) {
                ...
                .gateway => {
                    login_flow.runLogin(
                        ...
                        const message = switch (err) {
                            ...
                            error.AccessDenied => "ridex login: authorization denied\n",
                            error.ExpiredToken, error.LoginTimedOut => "ridex login: authorization expired; run ridex login again\n",
                            else => "ridex login: failed to sign in\n",
                        };
                        try writeStderr(deps, message);
                        return .handled_failure;
                    };
                ...
                .codex => {
                    chatgpt_oauth.runLogin(
                        ...
                        const message = switch (err) {
                            error.ChatGptLoginTimedOut => "ridex login: Codex authorization expired; run ridex login codex again\n",
                            error.ChatGptAuthorizationFailed => "ridex login: Codex authorization denied\n",
                            else => "ridex login: failed to sign in with Codex\n",
                        };
                        try writeStderr(deps, message);
                        return .handled_failure;
                    };
                ...
                .grok => {
                    grok_oauth.runLogin(
                        ...
                        try writeStderr(deps, "ridex login: failed to sign in with Grok\n");
                        return .handled_failure;
                    };
