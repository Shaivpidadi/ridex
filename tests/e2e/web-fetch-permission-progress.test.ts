...
describe("web_fetch permission progress", () => {
  test(
    ...
    async () => {
      ...
      expect(result.stderr).toContain("fx needs access to Vercel AI Gateway. Run ridex login to sign in, ridex setup to use an API key, or set AI_GATEWAY_API_KEY.");
